...
| **Agent UI (A2UI)**     | 19 shadcn/ui adapters (forms, cards, modals, icons); interactive form state via `useFormField`; 3-layer security (runtime validators, policy context, adapter enforcement); incremental streaming preserves form state         |
