...
export function UserMessage({ content, attachments }: UserMessageProps) {
  ...
  return (
    <motion.div className="flex justify-end" {...(shouldReduce ? {} : fadeInUp)}>
      <div className="max-w-[85%] lg:max-w-[72%] overflow-hidden rounded-[18px_18px_4px_18px] border border-[--border-user-message] bg-[--bg-user-message] backdrop-blur-md shadow-(--shadow-elevation-1)">
